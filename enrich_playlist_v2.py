...
def get_audio_features(access_token, track_ids, output_file='audio_features.json'):
    ...
    total_batches = (len(remaining_track_ids) + max_ids_per_request - 1) // max_ids_per_request
    for i in range(0, len(remaining_track_ids), max_ids_per_request):
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                current_batch = i // max_ids_per_request + 1
                print(f'Successfully fetched audio features for batch {current_batch}/{total_batches}')
